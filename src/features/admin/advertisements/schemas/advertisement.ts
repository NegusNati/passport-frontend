...
export const Advertisement = z
  ...
  .transform((data) => ({
    ...
    desktop_dark_asset_url: data.ad_desktop_dark_asset || '',
    mobile_asset_url: data.ad_mobile_asset || '',
    mobile_dark_asset_url: data.ad_mobile_dark_asset || '',
