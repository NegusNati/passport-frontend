...
export function PassportDetailCard({ passport, onCheckAnother }: PassportDetailCardProps) {
  ...
  return (
    <section className="bg-gradient-to-br from-red-50 to-amber-50 py-12 md:py-16">
      <Container>
        <div className="mx-auto max-w-4xl">
          {/* Passport Document */}
          <div className="relative overflow-hidden rounded-lg bg-white p-8 shadow-2xl md:p-12">
            ...
            <div className="relative z-10 mb-8 text-center">
              ...
              <h2 className="text-lg font-semibold text-red-700 md:text-xl">
            ...
            <div className="relative z-10 grid gap-8 md:grid-cols-2">
              ...
              <div className="flex flex-col items-center justify-center space-y-6">
                {/* Barcode */}
                <div className="rounded border-2 border-gray-300 bg-white p-4">
                  <Barcode
