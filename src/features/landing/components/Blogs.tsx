      ...
      <Container>
        <div className="mb-6 flex flex-col justify-center items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground text-center max-w-sm">Your reliable source for passport articles, tips, and travel information.</p>
          </div>
        ...
        <div className="flex sm:justify-center my-4 md:my-8">
          <Button size="sm" className="  sm:w-auto font-semibold">
