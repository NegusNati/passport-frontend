  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id={`grad-${uid}`} x1="-60" y1="0" x2="1500" y2="0" gradientUnits="userSpaceOnUse">
        ...
        <filter id={`glow-${uid}`} x="-60%" y="-80%" width="220%" height="260%" filterUnits="objectBoundingBox">
          {/* Tight bright rim */}
          <feDropShadow dx="0" dy="0" stdDeviation="4" floodColor={glowStrong} floodOpacity="0.95" />
          {/* Mid halo */}
          <feDropShadow dx="0" dy="0" stdDeviation="10" floodColor={glowStrong} floodOpacity="0.55" />
          {/* Outer halo */}
