...
export function ComingSoonDialog({ open, onOpenChange, title }: ComingSoonDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="m-2 self-center  w-[calc(80vw-2rem)] max-w-[560px] p-4 sm:mx-0 sm:w-full sm:p-6">
        ...
        >
          ...
          >
            <p className="text-foreground text-base leading-relaxed sm:text-lg">
              Our Privacy Policy and Terms are still in the oven — nothing&apos;s really cooked
              yet, but we promise it&apos;ll smell official when ready.
            </p>
          </motion.div>
        </motion.div>
      </DialogContent>
